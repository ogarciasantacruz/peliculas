					...
					<div class="kt-login-v2__body">
						...
						<div class="kt-login-v2__wrapper">
							<div class="kt-login-v2__container">
								...
								<!--begin::Form-->
								<form method="POST" class="kt-login-v2__form kt-form" action="{{ route('login') }}">
                                    @csrf
									<div class="form-group">
										<input class="form-control" type="text" placeholder="Usuario" name="email" value="{{ old('email') }}" required autocomplete="off" autofocus>
									</div>
									<div class="form-group">
									...
									<div class="kt-login-v2__actions">
										<a href="#" class="kt-link kt-link--brand">
											¿Olvidaste tu conraseña?
										</a>
										<button type="submit" class="btn btn-brand btn-elevate btn-pill">Iniciar sesión</button>
									</div>
