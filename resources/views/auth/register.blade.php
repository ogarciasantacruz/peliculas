...
<html lang="es">
	...
	<head>
		...
		<!--end::Base Path -->
		<meta charset="utf-8" />
		<title>La Netflix | Registro</title>
							...
							<div class="kt-login-v2__container">
                                ...
                                @if (count($errors) > 0)
                                    <div class="alert alert-danger">
                                        <ul style="list-style-type:none; margin: 0 auto; padding: 0;">
								...
								<!--begin::Form-->
								<form method="POST" class="kt-login-v2__form kt-form" action="{{ route('register') }}">
                                    @csrf
                                    <div class="form-group">
										<input class="form-control" type="text" placeholder="Nombre" name="name" value="{{ old('name') }}" required autocomplete="off" autofocus>
									</div>

                                    <div class="form-group">
										<input class="form-control" type="text" placeholder="Apellido" name="last_name" value="{{ old('last_name') }}" required autocomplete="off" autofocus>
									</div>

									<div class="form-group">
										<input class="form-control" type="text" placeholder="Email" name="email" value="{{ old('email') }}" required autocomplete="off" autofocus>
									</div>

                                    <div class="form-group">
										<input class="form-control" type="text" placeholder="Teléfono" name="phone" value="{{ old('phone') }}" autocomplete="off" autofocus>
									</div>

                                    <div class="form-group">
										<input class="form-control" type="text" placeholder="Edad" name="age" value="{{ old('age') }}" autocomplete="off" autofocus>
									</div>
                                    ...
                                    <div class="form-group">
										<input class="form-control" type="password" placeholder="Confirma tu password" name="password_confirmation" required autocomplete="off">
									</div>

									<!--begin::Action-->
									<div class="kt-login-v2__actions">
										
										<button type="submit" class="btn btn-brand btn-elevate btn-pill">Enviar</button>
									</div>
				...
				<div class="kt-grid__item">
					<div class="kt-login-v2__footer">
						...
						<div class="kt-login-v2__info">
							<a href="#" class="kt-link">&copy; 2020 Alejandro García</a>
						</div>
					</div>
				</div>
